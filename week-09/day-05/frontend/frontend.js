...
function buttonClick(baseURL, button, category, publisher, priceLo, priceHi) {
...
function eventHandler(baseURL) {
  ...
  // buttonClick(baseURL, button, category, publisher, priceLo, priceHi);
}

function core() {
  let baseURL = 'http://localhost:4000/books';
  ajax('GET', baseURL, null, createTable);
